...
const publishDir2 = "../node-express-boilerplate/src/contracts";
...
function publishContract(contractName, networkName) {
  try {
    ...
    fs.writeFileSync(
      `${publishDir2}/${contractName}.address.js`,
       `module.exports = "${contract.address}";`
     );
     fs.writeFileSync(
       `${publishDir2}/${contractName}.abi.js`,
       `module.exports = ${JSON.stringify(contract.abi, null, 2)};`
     );
     fs.writeFileSync(
       `${publishDir2}/${contractName}.bytecode.js`,
